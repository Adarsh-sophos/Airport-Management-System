...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript" async="" src="widget_data/ga.js"></script><script type="text/javascript" src="widget_data/jquery.js"></script>
    ...
    <style wix-style="">
        ...
        #tableWrapper::-webkit-scrollbar-track{background-color:#0088CB}
        #tableWrapper::-webkit-scrollbar-corner{background-color:#0088CB}
        #tableWrapper::-webkit-scrollbar-thumb{border-radius:5px;background-color:#0088CB;border:solid 1px #0088CB;}
        #tableWrapper::-webkit-scrollbar-thumb:hover{background-color:#BFDFE3;}
...
<div id="tableWrapper" style="overflow: auto; max-height: 419px;">
    <table id="theTable" class="footable table outerBorder footable-loaded isInnerColor" style="width: 100%; margin: 0px;">
<thead>
    <tr>
        <th id="thCol0" data-type="numeric">Airport Name</th>
        <th id="thCol1" data-type="numeric">City</th>
        <th id="thCol2" data-type="numeric">Country</th>
        <th id="thCol3" data-type="numeric">Website</th>
    </tr>
</thead>
