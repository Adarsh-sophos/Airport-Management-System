...
<div style="min-height: 535px; min-width: 478px; left: 502px; width: 478px; position: absolute; top: 67px; height: 680px;" class="tpaw0" id="comp-j9slsik5" data-reactid=".0.$SITE_ROOT.$desktop_siteRoot.$PAGES_CONTAINER.$centeredContent.$inlineContent.$SITE_PAGES.$e4uto_DESKTOP.$inlineContent.$comp-j9slsik5">
...
<div id="appView" class="">
  ...
  <div class="dynamicElements visible" style="display: block;">
      ...
      <fieldset>
          ...
          <legend class="fitText" style="font-size: 12px;"></legend>
            ...
            <label class="radioOption fitText horizontal" style="font-size: 12px;">
                ...
                <input name="sex" value="F" data-price="0" data-export-field="" placeholder="" style="font-size: 12px;" type="radio">
            ...
            <label class="radioOption fitText horizontal" style="font-size: 12px;">
                ...
                <input name="sex" value="M" data-price="0" data-export-field="" placeholder="" style="font-size: 12px;" type="radio">
    ...
    <div id="1" class="formElement form-group fadeMe text clearfix col-xs-6 half" style="">
      <label class="fitText" style="font-size: 12px;">SSN</label>
    ...
    <div id="2" class="formElement form-group fadeMe text clearfix col-xs-6 half" style="">
      <label class="fitText" style="font-size: 12px;">First Name</label>
      <input aria-describedby="2_errors" class="form-control user-success" name="fname" placeholder="" data-export-field="" title="Flight Number" type="text">
    </div>
