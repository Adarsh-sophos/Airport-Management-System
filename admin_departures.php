...
<div class="pc1" data-state="" id="PAGES_CONTAINER" style="width: 980px; position: absolute; top: 209px; height: 713px; left: 0px;"><div id="PAGES_CONTAINERscreenWidthBackground" class="pc1screenWidthBackground" style="width: 1519px; left: -270px;"></div><div id="PAGES_CONTAINERcenteredContent" class="pc1centeredContent"><div id="PAGES_CONTAINERbg" class="pc1bg"></div><div id="PAGES_CONTAINERinlineContent" class="pc1inlineContent"><div class="s_VOwPageGroupSkin" id="SITE_PAGES" style="left: 0px; width: 980px; position: absolute; top: 0px; height: 713px;"><div class="p2" id="lvvdu" style="left: 0px; width: 980px; position: absolute; top: 0px; height: 1260px; display: none;"><div id="lvvdubg" class="p2bg"></div><div id="lvvduinlineContent" class="p2inlineContent"></div></div><div class="p2" id="e4uto" style="left: 0px; width: 980px; position: absolute; top: 0px; height: 713px;"><div id="e4utobg" class="p2bg"></div><div id="e4utoinlineContent" class="p2inlineContent">
    ...
    <div class="tpaw0" id="comp-j9slsik5" style="min-height: 535px; min-width: 478px; left: 502px; width: 478px; position: absolute; top: 67px; height: 630px;">
...
<div id="appView" class="">
  <div class="formBuilder formElementsModule blockLabels enter_ani_none none">
    <div class="header clearfix">
      ...
      <form class="realForm" method="POST" action="add_departures.php">
...
<div class="elementWrapper">
    ...
    <div id="4" class="formElement form-group fadeMe text clearfix col-xs-6 half" style="">
      ...
      <input aria-describedby="4_errors" class="form-control user-success" name="schedule_date" id="schedule_date" placeholder="" data-export-field="" title="To_From" type="text">
    </div>
    ...
    <div id="5" class="formElement form-group fadeMe text clearfix col-xs-6 half" style="">
      ...
      <input aria-describedby="4_errors" class="form-control user-success" name="departing_to" id="departing_to" placeholder="" data-export-field="" title="To_From" type="text">
    </div>
    ...
    <div id="7" class="formElement form-group fadeMe text clearfix col-sm-12" style="">
      <label class="fitText" style="font-size: 12px;">Status</label>
      <input aria-describedby="4_errors" class="form-control user-success" name="status" id="status" placeholder="" data-export-field="" title="To_From" type="text">
    </div>

    <div id="8" class="formElement form-group fadeMe textarea clearfix col-sm-12" style="">
      <label class="fitText" style="font-size: 12px;">Flight Details</label>
      <textarea aria-describedby="5_errors" class="form-control user-success" name="details" placeholder="" data-max="250" data-limiting="false" style="height: 50px" data-export-field="" value="" id="details" title="Description" aria-label="Enter Text"></textarea>
