...
<div style="width: 980px; position: absolute; top: 203px; height: 1101px; left: 0px;" class="pc1" data-state="" id="PAGES_CONTAINER" data-reactid=".0.$SITE_ROOT.$desktop_siteRoot.$PAGES_CONTAINER"><div id="PAGES_CONTAINERscreenWidthBackground" class="pc1screenWidthBackground" data-reactid=".0.$SITE_ROOT.$desktop_siteRoot.$PAGES_CONTAINER.$screenWidthBackground" style="width: 1519px; left: -270px;"></div><div id="PAGES_CONTAINERcenteredContent" class="pc1centeredContent" data-reactid=".0.$SITE_ROOT.$desktop_siteRoot.$PAGES_CONTAINER.$centeredContent"><div id="PAGES_CONTAINERbg" class="pc1bg" data-reactid=".0.$SITE_ROOT.$desktop_siteRoot.$PAGES_CONTAINER.$centeredContent.$bg"></div><div id="PAGES_CONTAINERinlineContent" class="pc1inlineContent" data-reactid=".0.$SITE_ROOT.$desktop_siteRoot.$PAGES_CONTAINER.$centeredContent.$inlineContent"><div style="left: 0px; width: 980px; position: absolute; top: 0px; height: 1101px;" class="s_VOwPageGroupSkin" id="SITE_PAGES" data-reactid=".0.$SITE_ROOT.$desktop_siteRoot.$PAGES_CONTAINER.$centeredContent.$inlineContent.$SITE_PAGES"><div style="left: 0px; width: 980px; position: absolute; top: 0px; height: 1101px;" class="p2" id="f9d9i" data-reactid=".0.$SITE_ROOT.$desktop_siteRoot.$PAGES_CONTAINER.$centeredContent.$inlineContent.$SITE_PAGES.$f9d9i_DESKTOP"><div id="f9d9ibg" class="p2bg" data-reactid=".0.$SITE_ROOT.$desktop_siteRoot.$PAGES_CONTAINER.$centeredContent.$inlineContent.$SITE_PAGES.$f9d9i_DESKTOP.$bg"></div><div id="f9d9iinlineContent" class="p2inlineContent" data-reactid=".0.$SITE_ROOT.$desktop_siteRoot.$PAGES_CONTAINER.$centeredContent.$inlineContent.$SITE_PAGES.$f9d9i_DESKTOP.$inlineContent">
    ...
    <div style="left: 102px; width: 878px; overflow: hidden; position: absolute; top: 399px;" class="txtNew" id="comp-j9ckrbp14" data-reactid=".0.$SITE_ROOT.$desktop_siteRoot.$PAGES_CONTAINER.$centeredContent.$inlineContent.$SITE_PAGES.$f9d9i_DESKTOP.$inlineContent.$comp-j9ckrbp14" data-original-gap-between-text-and-btn="8" aria-hidden="true"><p class="font_8" style="text-align:justify;"><span style="font-weight:bold;">Buses
 are the most common and cheapest way to travel around the city. They
are fairly reliable and are one of the fastest ways to travel within the
 city too. Did you know that Delhi boasts of the World's largest
eco-friendly CNG bus service?</span></p>

<p class="font_8" style="text-align:justify;"><span style="font-weight:bold;">Most
 buses are owned either by the State-owned Malaviya&nbsp;Transport
Corporation (DTC) or the private contractors. The corporation runs
shuttle service at a regular interval (every 30 minutes) connecting the
airport to the central parts of Malaviya&nbsp;including Connaught Place
&amp; Interstate Bus Terminal. These buses are equipped with comfort of
air-conditioning and convenient for travel even with baggage at a
nominal fare.</span></p>

<p class="font_8" style="text-align:justify;"><span style="font-weight:bold;">All
 buses coming towards Terminal 3 will arrive and depart from a ‘staging
area’ located opposite Centaur Hotel. From there to the Airport Terminal
 IGIA will provide a shuttle bus, every 15 minutes. For the convenience
of our passengers this service will run 24x7.</span></p>

<p class="font_8" style="text-align:justify;"><span style="font-weight:bold;">Bus services</span></p>

<p class="font_8" style="text-align:justify;"><span style="font-weight:bold;">Regular
 bus services are available from inter-state bus terminals in the city.
The services are extended to all the northern states and the
neighbouring areas of Delhi. Services are provided by state transport
corporations and several private operators. The inter-state terminals in
 city are:</span></p>

<ul class="font_8" style="font-weight:bold; text-align:justify;">
	<li>
	<p class="font_8"><span style="font-weight:bold;">Kashmiri Gate ISBT in Northern Delhi</span></p>
	</li>
	<li>
	<p class="font_8"><span style="font-weight:bold;">Anand Vihar ISBT in Trans-Yamuna area</span></p>
	</li>
	<li>
	<p class="font_8"><span style="font-weight:bold;">Sarai Kale Khan ISBT in South-East Delhi</span></p>
	</li>
</ul>

<p class="font_8" style="text-align:justify;"><span style="font-weight:bold;">The
 DTC (Delhi transport Corporation has deployed over fairly large fleet
of environment friendly buses in different categories viz.
Air-conditioned, Non Air-conditioned covering all parts of Delhi.</span></p>

<p class="font_8" style="text-align:justify;"><span style="font-weight:bold;">Tips To Remember</span></p>

<p class="font_8" style="text-align:justify;"><span style="font-weight:bold;">Buses
 can be very crowded and may not be easy for a tourist visiting India
for the first time. Take your time at the bus stop and see for yourself
and then get on a bus.</span></p>

<p class="font_8" style="text-align:justify;"><span style="font-weight:bold;">One can approach the bus conductor for any help and emergencies. For more details visit<span style="text-decoration:underline;"><a href="http://dtc.nic.in/" target="_blank" data-content="http://dtc.nic.in/" data-type="external">http://dtc.nic.in/</a></span></span></p></div><div style="left: 102px; position: absolute; top: 148px; width: 873px; height: 212px;" data-exact-height="212" data-content-padding-horizontal="0" data-content-padding-vertical="0" title="" class="wp2" id="comp-j9cq6en0" data-reactid=".0.$SITE_ROOT.$desktop_siteRoot.$PAGES_CONTAINER.$centeredContent.$inlineContent.$SITE_PAGES.$f9d9i_DESKTOP.$inlineContent.$comp-j9cq6en0"><div style="width: 873px; height: 212px;" id="comp-j9cq6en0link" class="wp2link" data-reactid=".0.$SITE_ROOT.$desktop_siteRoot.$PAGES_CONTAINER.$centeredContent.$inlineContent.$SITE_PAGES.$f9d9i_DESKTOP.$inlineContent.$comp-j9cq6en0.$link"><div id="comp-j9cq6en0img" data-style="" class="wp2img" data-reactid=".0.$SITE_ROOT.$desktop_siteRoot.$PAGES_CONTAINER.$centeredContent.$inlineContent.$SITE_PAGES.$f9d9i_DESKTOP.$inlineContent.$comp-j9cq6en0.$link.0" style="position: relative; width: 873px; height: 212px;"><div class="wp2imgpreloader" id="comp-j9cq6en0imgpreloader" data-reactid=".0.$SITE_ROOT.$desktop_siteRoot.$PAGES_CONTAINER.$centeredContent.$inlineContent.$SITE_PAGES.$f9d9i_DESKTOP.$inlineContent.$comp-j9cq6en0.$link.0.$preloader"></div><img id="comp-j9cq6en0imgimage" alt="" data-type="image" data-reactid=".0.$SITE_ROOT.$desktop_siteRoot.$PAGES_CONTAINER.$centeredContent.$inlineContent.$SITE_PAGES.$f9d9i_DESKTOP.$inlineContent.$comp-j9cq6en0.$link.0.$image" style="width: 873px; height: 212px; object-fit: fill;" src="files/9fb5ca_771b9dcc10b94a6b9542b66a1be491e9mv2.jpg"></div></div></div></div></div></div></div></div></div></div></div><noscript data-reactid=".0.$popupRoot"></noscript><div class="siteAspectsContainer" data-reactid=".0.$siteAspectsContainer"><div data-reactid=".0.$siteAspectsContainer.$aspectPortal"></div><div data-reactid=".0.$siteAspectsContainer.$externalScriptContainer"></div><noscript data-reactid=".0.$siteAspectsContainer.$ecomCheckoutAspectContrainer"></noscript></div><noscript data-reactid=".0.6"></noscript><noscript data-reactid=".0.7"></noscript><noscript data-reactid=".0.8"></noscript></div></div>
